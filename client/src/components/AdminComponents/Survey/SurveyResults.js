...
const SurveyResults = () => {
    ...
    return(
        <div className="SurveyResults">
            ...
            <div className="d-inline-flex justify-content-center align-content-around flex-wrap bd-highlight example-parent"  >

                {chartsData.length > 0 && chartsData.map((item, index) => {
                        return <div className="p-2 bd-highlight col-example w-50">
                ...
                {commentUserAnswers.length>0 && commentUserAnswers.map(ans =>{
                        return <div className="p-2 bd-highlight col-example">
