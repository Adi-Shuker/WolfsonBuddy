...
const EditTeamMemberModal =({selectedDoctorDetails})=>{
        const [departmentsTitle, setDepartmentsTitle] = useState(selectedDoctorDetails.department_name);
        ...
        const [description, setDescription] = useState(selectedDoctorDetails.description);
        const [picture, setPicture] = useState("");
        const [phone_number, setPhone_number] = useState(selectedDoctorDetails.phone_number);
        const [clinical_practice, setClinical_practice] = useState(selectedDoctorDetails.clinical_practice);
        const [scientific_practice, setScientific_practice] = useState(selectedDoctorDetails.scientific_practice);
        const [academic_experience, setAcademic_experience] = useState(selectedDoctorDetails.academic_experience);
        const [professional_unions, setProfessional_unions] = useState(selectedDoctorDetails.professional_unions);
